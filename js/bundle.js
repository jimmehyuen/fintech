...
document.addEventListener('DOMContentLoaded', function () {
  if ($(".type").length !== 0) {
    var typed = new _typed["default"]('.type', {
      strings: ["innovate", "modernize", "#build"],
      typeSpeed: 40,
      fadeOut: true,
      fadeOutDelay: 200,
      loop: true,
  ...
  var insightsopen = sessionStorage.getItem('insightsopen');

  if (insightsopen) {
    $('.showmore').remove();
    $(".showmore-show").addClass("open");
  }
  ...
  $('.showmore').click(function (e) {
    ...
    $(this).remove();
    $(".showmore-show").addClass("open");
    sessionStorage.setItem('insightsopen', true);
  });
  $('a.scroll').click(function (e) {
    var hashValue = $.attr(this, 'href');
    ...
    if (jQuery(hashValue).length) {
      ...
      console.log("offset", offset);
      $('html, body').animate({
        scrollTop: jQuery($.attr(this, 'href')).offset().top - offset
      }, 500);
      return false;
    }
  });
